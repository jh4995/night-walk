...
> 생성 2026-08-07 · 모델 `bammasil_det_c4d_11s_640_640.onnx`
...
| 아키텍처 | yolo11s (ultralytics · 9.43M params) |
| 입력 | `images` · `[1, 3, 640, 640]` · `tensor(float)` |
| 파라미터 정밀도 | FP32 |
| opset | 12 |
| 파일 크기 | 37.93 MB |
| SHA-256 | `8a2c89e8f82c6bef4a4a0910e8413aac6a7b82f9331ae407c3fdfc010e9d7617` |
...
⚠️ **이 런(`c4d_11s_640`)의 held-out 실측치가 등록돼 있지 않다.**
...
```powershell
Get-FileHash bammasil_det_c4d_11s_640_640.onnx -Algorithm SHA256
# → 8a2c89e8f82c6bef4a4a0910e8413aac6a7b82f9331ae407c3fdfc010e9d7617
```

## 재현

```powershell
uv run python scripts/export_onnx.py --imgsz 640 --opset 12 --weights received/bammasil_weights/c4d_11s_640/best.pt --val-images outputs/datasets/detect_v3_bollard/images/val --name c4d_11s_640
```

원본 가중치: `received/bammasil_weights/c4d_11s_640/best.pt` (SHA-256 `46d86cb4981e3539…`)
