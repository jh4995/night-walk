...
> 생성 2026-08-07 · 모델 `bammasil_det_c4d_11n_640_640.onnx`
...
| opset | 12 |
| 파일 크기 | 10.61 MB |
| SHA-256 | `e4e85bbcb0e7d859028612047e4f885513edf137cf3074dc0a6d2df88a9d301f` |
...
⚠️ **이 런(`c4d_11n_640`)의 held-out 실측치가 등록돼 있지 않다.**
...
```powershell
Get-FileHash bammasil_det_c4d_11n_640_640.onnx -Algorithm SHA256
# → e4e85bbcb0e7d859028612047e4f885513edf137cf3074dc0a6d2df88a9d301f
```

## 재현

```powershell
uv run python scripts/export_onnx.py --imgsz 640 --opset 12 --weights received/bammasil_weights/c4d_11n_640/best.pt --val-images outputs/datasets/detect_v3_bollard/images/val --name c4d_11n_640
```

원본 가중치: `received/bammasil_weights/c4d_11n_640/best.pt` (SHA-256 `c94622bd9e6f7dd6…`)
